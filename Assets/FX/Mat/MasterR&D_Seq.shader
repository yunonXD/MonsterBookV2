	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float temp_output_4_0_g9 = _SeqXY.x;
				float temp_output_5_0_g9 = _SeqXY.y;
				...
				float mulTime173 = _TimeParameters.x * _time;
				float clampResult42_g9 = clamp( _StartFrame , 0.0001 , ( totalFrames39_g9 - 1.0 ) );
				float temp_output_35_0_g9 = frac( ( ( mulTime173 + clampResult42_g9 ) / totalFrames39_g9 ) );
				float2 appendResult29_g9 = (float2(temp_output_35_0_g9 , ( 1.0 - temp_output_35_0_g9 )));
				float2 temp_output_15_0_g9 = ( ( IN.ase_texcoord3.xy / appendResult7_g9 ) + ( floor( ( appendResult8_g9 * appendResult29_g9 ) ) / appendResult7_g9 ) );
				float2 temp_output_169_0 = temp_output_15_0_g9;
				...
				float temp_output_66_0 = ( tex2D( _Main_Tex, (( _Distortion )?( ( ( _DistortionStr * tex2D( _Distortion_Tex, (( _Distortion_Panning )?( panner39 ):( (( _DistortionPolar )?( appendResult23_g1 ):( uv_Distortion_Tex )) )) ).r ) + temp_output_169_0 ) ):( temp_output_169_0 )) ).r * _MainStr );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float temp_output_35_0_g9 = frac( ( ( mulTime173 + clampResult42_g9 ) / totalFrames39_g9 ) );
				float2 appendResult29_g9 = (float2(temp_output_35_0_g9 , ( 1.0 - temp_output_35_0_g9 )));
				float2 temp_output_15_0_g9 = ( ( IN.ase_texcoord2.xy / appendResult7_g9 ) + ( floor( ( appendResult8_g9 * appendResult29_g9 ) ) / appendResult7_g9 ) );
				float2 temp_output_169_0 = temp_output_15_0_g9;
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float temp_output_35_0_g9 = frac( ( ( mulTime173 + clampResult42_g9 ) / totalFrames39_g9 ) );
				float2 appendResult29_g9 = (float2(temp_output_35_0_g9 , ( 1.0 - temp_output_35_0_g9 )));
				float2 temp_output_15_0_g9 = ( ( IN.ase_texcoord.xy / appendResult7_g9 ) + ( floor( ( appendResult8_g9 * appendResult29_g9 ) ) / appendResult7_g9 ) );
				float2 temp_output_169_0 = temp_output_15_0_g9;
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float temp_output_35_0_g9 = frac( ( ( mulTime173 + clampResult42_g9 ) / totalFrames39_g9 ) );
				float2 appendResult29_g9 = (float2(temp_output_35_0_g9 , ( 1.0 - temp_output_35_0_g9 )));
				float2 temp_output_15_0_g9 = ( ( IN.ase_texcoord1.xy / appendResult7_g9 ) + ( floor( ( appendResult8_g9 * appendResult29_g9 ) ) / appendResult7_g9 ) );
				float2 temp_output_169_0 = temp_output_15_0_g9;
...
/*ASEBEGIN
Version=18935
2127;81;1274;682;2562.999;328.8604;1.490352;True;False
Node;AmplifyShaderEditor.CommentaryNode;47;-3279.52,-69.30919;Inherit;False;1450.268;460.3232;UVDistortion;12;50;32;34;39;68;65;36;69;37;38;35;167;;1,1,1,1;0;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;38;-3233.469,-40.57082;Inherit;False;0;32;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;35;-3214.786,213.1473;Inherit;False;Property;_DistortionPanCtrl;DistortionPanCtrl;21;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;167;-3134.685,122.7412;Inherit;False;Property;_PolarLength;PolarLength;19;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;69;-2964.878,34.1453;Inherit;False;Polar Coordinates;-1;;1;7dab8e02884cf104ebefaa2e788e4162;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0.5,0.5;False;3;FLOAT;1;False;4;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleTimeNode;37;-2972.874,260.8622;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;68;-2730.464,-23.79571;Inherit;False;Property;_DistortionPolar;DistortionPolar;18;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.DynamicAppendNode;36;-2806.693,174.1003;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector4Node;41;-1911.744,931.8199;Inherit;False;Property;_DissolvePanCtrl;DissolvePanCtrl;10;0;Create;True;0;0;0;False;0;False;0,0,0,0;-1,0,1,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;168;-1895.383,842.673;Inherit;False;Property;_PolarLengthh;PolarLengthh;8;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector4Node;156;-1584.846,1340.939;Inherit;False;Property;_DissolveMaskCtrlZ;DissolveMaskCtrl(Z);13;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;65;-2733.767,289.5725;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.PannerNode;39;-2614.71,191.8015;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ToggleSwitchNode;34;-2422.266,94.6765;Inherit;False;Property;_Distortion_Panning;Distortion_Panning;20;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;70;-1449.842,692.6879;Inherit;False;Property;_DissolvePolar;DissolvePolar;7;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;174;-1804.091,459.5236;Inherit;False;Property;_time;time;28;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;32;-2150.851,112.4037;Inherit;True;Property;_Distortion_Tex;Distortion_Tex;17;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleTimeNode;173;-1656.521,428.9555;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;176;-1788.28,359.3872;Inherit;False;Property;_StartFrame;StartFrame;27;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;50;-2073.254,-52.82992;Inherit;False;Property;_DistortionStr;DistortionStr;16;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;171;-1660.834,274.2548;Inherit;False;Property;_SeqXY;SeqXY;26;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;49;-1689.084,-37.97078;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;169;-1464.578,279.4249;Inherit;False;Flipbook;-1;;9;53c2488c220f6564ca6c90721ee16673;2,71,0,68,0;8;51;SAMPLER2D;0.0;False;13;FLOAT2;0,0;False;4;FLOAT;3;False;5;FLOAT;3;False;24;FLOAT;0;False;2;FLOAT;0;False;55;FLOAT;0;False;70;FLOAT;0;False;5;COLOR;53;FLOAT2;0;FLOAT;47;FLOAT;48;FLOAT;62
Node;AmplifyShaderEditor.ToggleSwitchNode;40;-1133.698,718.1737;Inherit;False;Property;_Dissolve_Panning;Dissolve_Panning;9;0;Create;True;0;0;0;False;0;False;1;True;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;53;-1075.203,942.6729;Inherit;False;Property;_DissolveStr;DissolveStr;4;0;Create;True;0;0;0;False;0;False;-1;-0.52;-2;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;30;-913.3332,703.8494;Inherit;True;Property;_Dissolve_Tex;Dissolve_Tex;6;0;Create;True;0;0;0;False;0;False;-1;None;20c0b0cb78525ae45af8eb078147784a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;48;-1460.594,-21.21992;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ToggleSwitchNode;81;-1034.813,1023.135;Inherit;False;Property;_DissovleStrCustomY;DissovleStrCustom(Y);5;0;Create;True;0;0;0;False;0;False;1;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;145;-437.2972,1222.506;Inherit;False;Property;_DissolveMaskPow;DissolveMaskPow;14;0;Create;True;0;0;0;False;0;False;6.21;6.21;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;140;-761.3057,1200.643;Inherit;True;Property;_DissolveMaskDirection;DissolveMaskDirection;12;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;33;-1210.067,105.541;Inherit;False;Property;_Distortion;Distortion;15;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;15;-687.8295,100.3217;Inherit;True;Property;_Main_Tex;Main_Tex;2;0;Create;True;0;0;0;False;0;False;-1;None;3a0b5bfc117d6494b82e55b6d533afad;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;67;-536.4541,304.2696;Inherit;False;Property;_MainStr;MainStr;1;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;147;-357.0491,816.6555;Inherit;True;Property;_DissolveMaskVer;DissolveMaskVer;11;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;31;35.89084,171.7664;Inherit;False;Property;_Dissolve;Dissolve;3;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;102;563.8843,-473.2518;Inherit;False;Property;_MaskDirectionY;MaskDirectionY;22;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;128;-453.6904,-945.3161;Inherit;False;Property;_MaskTexStr;MaskTexStr;29;0;Create;True;0;0;0;False;0;False;1;1;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;118;-742.3595,-1062.718;Inherit;True;Property;_MaskTex;MaskTex;25;0;Create;True;0;0;0;False;0;False;118;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ToggleSwitchNode;108;970.9229,-121.9899;Inherit;False;Property;_MaskDirectionX;MaskDirectionX;23;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;115;1241.275,-124.6677;Inherit;True;Property;_MaskTexture;MaskTexture;24;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;61;2353.82,292.9608;Inherit;False;Property;_DepthFade;DepthFade;31;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;132;2095.623,-24.18563;Inherit;False;Property;_Toon;Toon;30;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
WireConnection;169;4;171;1
WireConnection;169;5;171;2
WireConnection;169;24;176;0
...
ASEEND*/
//CHKSM=EAD693EEA81DA15BCBBDAAFDD65426EF749A6ACB