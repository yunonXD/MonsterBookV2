...
Shader "UltimateFX"
{
	Properties
	{
		...
		_range("range", Float) = 3.73
		_inten("inten", Float) = 0
		_opactiy("opactiy", Float) = 0
		_Vector0("Vector 0", Vector) = (1,1,0,0)
		[Toggle]_rangeCtrl("rangeCtrl", Float) = 1
		[ASEEnd]_PanCtrlv("PanCtrlv", Vector) = (1,1,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 appendResult23 = (float2(texCoord51.x , texCoord51.y));
				float2 texCoord35 = IN.ase_texcoord3.zw * float2( 1,1 ) + float2( 0,0 );
				float mulTime49 = _TimeParameters.x * _PanCtrlv.z;
				float2 appendResult48 = (float2(_PanCtrlv.x , _PanCtrlv.y));
				float2 CenteredUV15_g1 = ( appendResult23 - float2( 0.5,0.5 ) );
				float2 break17_g1 = CenteredUV15_g1;
				float2 appendResult23_g1 = (float2(( length( CenteredUV15_g1 ) * _Vector0.x * 2.0 ) , ( atan2( break17_g1.x , break17_g1.y ) * ( 1.0 / TWO_PI ) * _Vector0.y )));
				float2 panner46 = ( ( mulTime49 + _PanCtrlv.w ) * appendResult48 + appendResult23_g1);
				float temp_output_21_0 = ( pow( length( ( appendResult23 + -0.5 ) ) , (( _rangeCtrl )?( texCoord35.x ):( _range )) ) * ( tex2D( _TextureSample0, panner46 ).r * _opactiy ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( IN.ase_color * temp_output_21_0 * _inten ).rgb;
				float Alpha = ( IN.ase_color.a * temp_output_21_0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult23 = (float2(texCoord51.x , texCoord51.y));
				float2 texCoord35 = IN.ase_texcoord2.zw * float2( 1,1 ) + float2( 0,0 );
				float mulTime49 = _TimeParameters.x * _PanCtrlv.z;
				float2 appendResult48 = (float2(_PanCtrlv.x , _PanCtrlv.y));
				float2 CenteredUV15_g1 = ( appendResult23 - float2( 0.5,0.5 ) );
				float2 break17_g1 = CenteredUV15_g1;
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 appendResult23 = (float2(texCoord51.x , texCoord51.y));
				float2 texCoord35 = IN.ase_texcoord.zw * float2( 1,1 ) + float2( 0,0 );
				float mulTime49 = _TimeParameters.x * _PanCtrlv.z;
				float2 appendResult48 = (float2(_PanCtrlv.x , _PanCtrlv.y));
				float2 CenteredUV15_g1 = ( appendResult23 - float2( 0.5,0.5 ) );
				float2 break17_g1 = CenteredUV15_g1;
				...
				surfaceDescription.Alpha = ( IN.ase_color.a * temp_output_21_0 );
        ...
        Pass
        {
			...
			{
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord51 = IN.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult23 = (float2(texCoord51.x , texCoord51.y));
				float2 texCoord35 = IN.ase_texcoord1.zw * float2( 1,1 ) + float2( 0,0 );
				float mulTime49 = _TimeParameters.x * _PanCtrlv.z;
				float2 appendResult48 = (float2(_PanCtrlv.x , _PanCtrlv.y));
				float2 CenteredUV15_g1 = ( appendResult23 - float2( 0.5,0.5 ) );
				float2 break17_g1 = CenteredUV15_g1;
...
/*ASEBEGIN
Version=18935
132;425.6;1463.2;635;1915.289;491.5602;1.320389;True;False
Node;AmplifyShaderEditor.Vector4Node;47;-425.5187,196.0769;Inherit;False;Property;_PanCtrlv;PanCtrlv;6;0;Create;True;0;0;0;False;0;False;1,1,0,0;1,0.1,1,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;51;-1013.463,-193.4164;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;32;-562.1038,-49.08895;Inherit;False;Property;_Vector0;Vector 0;4;0;Create;True;0;0;0;False;0;False;1,1;0.48,5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.DynamicAppendNode;23;-721.0938,-166.6338;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleTimeNode;49;-196.5187,247.0769;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;48;-270.5187,159.0769;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleAddOpNode;50;-10.47986,271.0768;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;25.03529,-231.5526;Inherit;False;Constant;_Float0;Float 0;1;0;Create;True;0;0;0;False;0;False;-0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;31;-314.192,-99.2466;Inherit;False;Polar Coordinates;-1;;1;7dab8e02884cf104ebefaa2e788e4162;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0.5,0.5;False;3;FLOAT;1;False;4;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;18;357.4459,-266.651;Inherit;False;Property;_range;range;1;0;Create;True;0;0;0;False;0;False;3.73;0.09;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;35;262.2285,-172.6017;Inherit;False;1;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;12;264.0067,-340.4527;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PannerNode;46;205.319,-9.07659;Inherit;True;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;10;510.682,-28.15365;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;10;None;a23372ee982ab3841a3b6294eeb707ef;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;27;725.7564,180.9435;Inherit;False;Property;_opactiy;opactiy;3;0;Create;True;0;0;0;False;0;False;0;20.24;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LengthOpNode;15;416.0341,-335.8457;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;33;507.2285,-263.6017;Inherit;False;Property;_rangeCtrl;rangeCtrl;5;0;Create;True;0;0;0;False;0;False;1;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;17;690.6497,-345.1563;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;29;909.8274,57.75787;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;1051.221,-109.2194;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;24;970.7131,-425.0744;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;26;1095.314,-207.0212;Inherit;False;Property;_inten;inten;2;0;Create;True;0;0;0;False;0;False;0;0.49;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;25;1321.863,-255.1629;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;1321.863,-82.41943;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ScreenPosInputsNode;22;-984.3797,-185.8013;Float;False;0;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;1487.262,-107.6535;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;UltimateFX;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;True;2;False;-1;True;7;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;638032323042438387;  Blend;0;0;Two Sided;1;0;Cast Shadows;0;638032323047209180;  Use Shadow Threshold;0;0;Receive Shadows;0;638032323052098290;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=0A11EF6CD8F17C2213F205EC982D43C8DFD7028B