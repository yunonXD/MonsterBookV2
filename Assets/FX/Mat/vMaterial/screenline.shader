...
Shader "Custom/screenline"
{
	Properties
	{
		...
		_Vector0("Vector 0", Vector) = (0.51,1.36,0,0)
		_radial("radial", Float) = 0
		_length("length", Float) = 0
		[ASEEnd]_inten("inten", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float smoothstepResult16 = smoothstep( _Vector0.x , _Vector0.y , ( 1.0 - length( ( IN.ase_texcoord3.xy + -0.5 ) ) ));
				float2 uv_TextureSample0 = IN.ase_texcoord3.xy * _TextureSample0_ST.xy + _TextureSample0_ST.zw;
				float2 CenteredUV15_g1 = ( uv_TextureSample0 - float2( 0.5,0.5 ) );
				float2 break17_g1 = CenteredUV15_g1;
				float2 appendResult23_g1 = (float2(( length( CenteredUV15_g1 ) * _radial * 2.0 ) , ( atan2( break17_g1.x , break17_g1.y ) * ( 1.0 / TWO_PI ) * _length )));
				float temp_output_20_0 = ( smoothstepResult16 * tex2D( _TextureSample0, appendResult23_g1 ).r );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( IN.ase_color * temp_output_20_0 ).rgb;
				float Alpha = ( IN.ase_color.a * temp_output_20_0 * _inten );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float smoothstepResult16 = smoothstep( _Vector0.x , _Vector0.y , ( 1.0 - length( ( IN.ase_texcoord2.xy + -0.5 ) ) ));
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float smoothstepResult16 = smoothstep( _Vector0.x , _Vector0.y , ( 1.0 - length( ( IN.ase_texcoord.xy + -0.5 ) ) ));
				...
				surfaceDescription.Alpha = ( IN.ase_color.a * temp_output_20_0 * _inten );
        ...
        Pass
        {
			...
			{
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float smoothstepResult16 = smoothstep( _Vector0.x , _Vector0.y , ( 1.0 - length( ( IN.ase_texcoord1.xy + -0.5 ) ) ));
...
/*ASEBEGIN
Version=18935
2075;302;1274;664;642.516;413.0107;1;True;False
Node;AmplifyShaderEditor.TexCoordVertexDataNode;11;-457.8896,-234.6397;Inherit;False;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;13;-344.6322,-100.0034;Inherit;False;Constant;_Float0;Float 0;0;0;Create;True;0;0;0;False;0;False;-0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;12;-140.6322,-203.0034;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.LengthOpNode;14;24.3678,-203.0034;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;28;-995.057,20.43224;Inherit;False;0;19;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;24;-778.4812,173.798;Inherit;False;Property;_radial;radial;2;0;Create;True;0;0;0;False;0;False;0;2.55;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-776.4812,251.798;Inherit;False;Property;_length;length;3;0;Create;True;0;0;0;False;0;False;0;3.57;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;18;12.96778,-88.20338;Inherit;False;Property;_Vector0;Vector 0;1;0;Create;True;0;0;0;False;0;False;0.51,1.36;1.1,1.01;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.FunctionNode;23;-517.6685,84.1981;Inherit;False;Polar Coordinates;-1;;1;7dab8e02884cf104ebefaa2e788e4162;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0.5,0.5;False;3;FLOAT;1;False;4;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.OneMinusNode;15;164.3678,-282.0034;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;16;370.3793,-255.7144;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;19;-155.5748,77.77325;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;19;None;492d3f34c4a2dfc44b37aed9c24db89b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;29;825.4402,207.1714;Inherit;False;Property;_inten;inten;4;0;Create;True;0;0;0;False;0;False;0;0.65;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;21;833.1479,-210.4812;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;604.3121,45.17519;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;994.6241,106.6752;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;26;1048.812,-11.49494;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;1198.298,16.53825;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;Custom/screenline;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;True;2;False;-1;True;7;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;638035749395597871;  Blend;0;0;Two Sided;0;638035749387874027;Cast Shadows;0;638035749375868372;  Use Shadow Threshold;0;0;Receive Shadows;0;638035749381591203;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;True;True;True;True;True;False;;False;0
WireConnection;12;0;11;0
WireConnection;12;1;13;0
WireConnection;14;0;12;0
WireConnection;23;1;28;0
WireConnection;23;3;24;0
WireConnection;23;4;25;0
...
ASEEND*/
//CHKSM=47A7BABB64B3D3A56C994F517DF6391179119060