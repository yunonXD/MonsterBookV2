...
Shader "FX/Boss/Anna/FrozenScreen"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_Frozen_Texture("Frozen_Texture", 2D) = "white" {}
		_Frozen_Color("Frozen_Color", Color) = (0,0,0,0)
		_Hightlight_Boundary("Hightlight_Boundary", Float) = 0
		_Highlight_Color("Highlight_Color", Color) = (0,0,0,0)
		_Hightlight_Inten("Hightlight_Inten", Float) = 0
		_Frozen_Boundary("Frozen_Boundary", Range( 1 , 5)) = 3
		_Frozen_Control("Frozen_Control", Range( -1 , 1)) = -0.2101779
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Frozen_Texture_ST;
			float4 _Frozen_Color;
			float _Hightlight_Boundary;
			float _Hightlight_Inten;
			float _Frozen_Control;
			float _Frozen_Boundary;
			float _Opacity;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float2 uv_Frozen_Texture = IN.ase_texcoord3.xy * _Frozen_Texture_ST.xy + _Frozen_Texture_ST.zw;
				float4 tex2DNode11 = tex2D( _Frozen_Texture, uv_Frozen_Texture );
				float2 texCoord12 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 CenteredUV15_g1 = ( texCoord12 - float2( 0.5,0.5 ) );
				float2 break17_g1 = CenteredUV15_g1;
				float2 appendResult23_g1 = (float2(( length( CenteredUV15_g1 ) * 1.0 * 2.0 ) , ( atan2( break17_g1.x , break17_g1.y ) * ( 1.0 / TWO_PI ) * 1.0 )));
				float4 temp_output_51_0 = ( ( ( _Highlight_Color * pow( tex2DNode11.r , _Hightlight_Boundary ) * _Hightlight_Inten ) + ( _Frozen_Color * tex2DNode11.r ) ) * pow( ((appendResult23_g1).x*1.0 + _Frozen_Control) , _Frozen_Boundary ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = temp_output_51_0.rgb;
				float Alpha = saturate( ( ( temp_output_51_0 + float4( 0,0,0,0 ) ) * _Opacity ) ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_Frozen_Texture = IN.ase_texcoord2.xy * _Frozen_Texture_ST.xy + _Frozen_Texture_ST.zw;
				float4 tex2DNode11 = tex2D( _Frozen_Texture, uv_Frozen_Texture );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 uv_Frozen_Texture = IN.ase_texcoord.xy * _Frozen_Texture_ST.xy + _Frozen_Texture_ST.zw;
				float4 tex2DNode11 = tex2D( _Frozen_Texture, uv_Frozen_Texture );
				...
				surfaceDescription.Alpha = saturate( ( ( temp_output_51_0 + float4( 0,0,0,0 ) ) * _Opacity ) ).r;
        ...
        Pass
        {
			...
			{
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 uv_Frozen_Texture = IN.ase_texcoord1.xy * _Frozen_Texture_ST.xy + _Frozen_Texture_ST.zw;
				float4 tex2DNode11 = tex2D( _Frozen_Texture, uv_Frozen_Texture );
...
/*ASEBEGIN
Version=18935
7;6;1906;1013;248.974;253.625;1.033055;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;12;-188.2845,122.2823;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;11;-103.2027,-100.8655;Inherit;True;Property;_Frozen_Texture;Frozen_Texture;0;0;Create;True;0;0;0;False;0;False;-1;None;5ac50f92106d2cb4fb41f529785b0463;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;38;38.5177,-388.8703;Inherit;False;Property;_Hightlight_Boundary;Hightlight_Boundary;2;0;Create;True;0;0;0;False;0;False;0;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;13;124.7155,194.2824;Inherit;False;Polar Coordinates;-1;;1;7dab8e02884cf104ebefaa2e788e4162;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0.5,0.5;False;3;FLOAT;1;False;4;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ComponentMaskNode;14;435.7154,245.2825;Inherit;False;True;False;True;True;1;0;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;41;328.5177,-218.8703;Inherit;False;Property;_Hightlight_Inten;Hightlight_Inten;4;0;Create;True;0;0;0;False;0;False;0;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;37;277.5177,-428.8703;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;28;-15,-271.5;Inherit;False;Property;_Frozen_Color;Frozen_Color;1;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.7311321,0.8737669,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;39;301.5177,-607.8703;Inherit;False;Property;_Highlight_Color;Highlight_Color;3;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;65;413.3502,323.1455;Inherit;False;Property;_Frozen_Control;Frozen_Control;6;0;Create;True;0;0;0;False;0;False;-0.2101779;-0.2101779;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ScaleAndOffsetNode;64;736.2573,250.6142;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0.05;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;717.3011,378.3174;Inherit;False;Property;_Frozen_Boundary;Frozen_Boundary;5;0;Create;True;0;0;0;False;0;False;3;5;1;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;29;308,-144.5;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;40;566.5177,-453.8703;Inherit;True;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;42;912.5177,-163.8703;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.PowerNode;15;1044.17,283.9936;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;51;1364.682,39.54272;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;59;1752.663,158.5134;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;63;1826.939,376.526;Inherit;False;Property;_Opacity;Opacity;7;0;Create;True;0;0;0;False;0;False;0;1.3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;62;2014.914,259.9323;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;60;2272.663,181.5134;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;2495.48,46.08234;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;FX/Boss/Anna/FrozenScreen;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;638039374532742774;  Blend;0;0;Two Sided;1;0;Cast Shadows;0;638039374569415783;  Use Shadow Threshold;0;0;Receive Shadows;0;638039374577083249;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=6CC26063906312E189DDA152C7C8538AFDA6F52F