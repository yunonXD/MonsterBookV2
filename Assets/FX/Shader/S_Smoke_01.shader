	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( IN.ase_color * _Intensity ).rgb;
				float Alpha = ( ( pow( saturate( ( tex2D( _Tex_01, uv_Tex_01 ).a * _Opacity ) ) , _Power ) * IN.ase_color.a ) * distanceDepth26 );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = ( ( pow( saturate( ( tex2D( _Tex_01, uv_Tex_01 ).a * _Opacity ) ) , _Power ) * IN.ase_color.a ) * distanceDepth26 );
...
/*ASEBEGIN
Version=18935
0;0;1920;1019;1030.913;680.192;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;41;160.087,-169.192;Inherit;False;Property;_Intensity;Intensity;3;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;28;142.0954,-362.3906;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;37;380.677,-235.182;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=6A23711C9E0857FF21AA6C3263DEDF171A600002