...
Shader "S_Thorn_01"
{
	Properties
	{
		...
		[ASEBegin]_Edge_Soft_Amount("Edge_Soft_Amount", Float) = 1
		_Fre_Scale("Fre_Scale", Float) = 1
		_Fre_Power("Fre_Power", Float) = 5
		_Fre_Color("Fre_Color", Color) = (1,0.736212,0.2122642,0)
		_Fre_Inten("Fre_Inten", Float) = 3
		[ASEEnd]_Base_Color("Base_Color", Color) = (1,0.4908952,0.08018869,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float fresnelNode10 = ( 0.0 + _Fre_Scale * pow( 1.0 - fresnelNdotV10, _Fre_Power ) );
				float dotResult13 = dot( ase_worldViewDir , IN.ase_normal );
				float temp_output_14_0 = pow( dotResult13 , _Edge_Soft_Amount );
				
				float4 screenPos = IN.ase_texcoord4;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth41 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth41 = saturate( abs( ( screenDepth41 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( 1.0 ) ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( ( ( _Fre_Color * ( 1.0 - saturate( fresnelNode10 ) ) * _Fre_Inten ) + ( temp_output_14_0 * _Base_Color ) ) * temp_output_14_0 ).rgb;
				float Alpha = saturate( ( ( temp_output_14_0 * IN.ase_color.a ) * distanceDepth41 ) );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = saturate( ( ( temp_output_14_0 * IN.ase_color.a ) * distanceDepth41 ) );
...
/*ASEBEGIN
Version=18935
1920;0;1920;1019;1151.348;691.4627;1;True;False
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;11;-1068,-307.5;Inherit;False;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.NormalVertexDataNode;12;-1064,-149.5;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;15;-890,-117.5;Inherit;False;Property;_Edge_Soft_Amount;Edge_Soft_Amount;0;0;Create;True;0;0;0;False;0;False;1;2.07;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DotProductOpNode;13;-842,-233.5;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;29;-573.0864,191.865;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PowerNode;14;-641,-193.5;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.DepthFade;41;-287.9543,363.8157;Inherit;False;True;True;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;-120.7864,111.565;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;38;213.7752,194.7931;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;18;-685,-523.5;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-1095,-533.5;Inherit;False;Property;_Fre_Scale;Fre_Scale;1;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FresnelNode;10;-929,-583.5;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;31;-614.2864,18.36499;Inherit;False;Property;_Base_Color;Base_Color;5;0;Create;True;0;0;0;False;0;False;1,0.4908952,0.08018869,0;1,0.4908952,0.08018869,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;17;-1101,-455.5;Inherit;False;Property;_Fre_Power;Fre_Power;2;0;Create;True;0;0;0;False;0;False;5;0.17;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;35;666.3876,-16.53758;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;27;-482,-400.5;Inherit;False;Property;_Fre_Inten;Fre_Inten;4;0;Create;True;0;0;0;False;0;False;3;25.18;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;26;-170,-521.5;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.OneMinusNode;33;-485.6864,-477.2349;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;24;466.3373,-204.7995;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;25;-767,-750.5;Inherit;False;Property;_Fre_Color;Fre_Color;3;0;Create;True;0;0;0;False;0;False;1,0.736212,0.2122642,0;1,0.736212,0.2122642,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;23;171.7383,-420.6284;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;-67.55389,-294.5066;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;907.749,-144.9252;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;S_Thorn_01;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;637994283788558034;  Blend;0;0;Two Sided;1;637994399327886819;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=217F07CE8F962A1255F61A67BB155A7F07025B5E