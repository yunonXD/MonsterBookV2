...
Shader "Basic"
{
	Properties
	{
		...
		[ASEEnd]_Dissolve_Tex("Dissolve_Tex", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 texCoord25 = IN.ase_texcoord3.zw * float2( 1,1 ) + float2( 0,0 );
				float2 temp_cast_0 = (texCoord25.y).xx;
				float2 texCoord17 = IN.ase_texcoord3.xy * float2( 1,1 ) + temp_cast_0;
				float temp_output_27_0 = ( ( tex2D( _Main_Tex, uv_Main_Tex ).r * texCoord25.x ) - tex2D( _Dissolve_Tex, texCoord17 ).r );
				float temp_output_24_0 = saturate( temp_output_27_0 );
				...
				float distanceDepth35 = saturate( abs( ( screenDepth35 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( 0.5 ) ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( IN.ase_color * _inten * temp_output_24_0 ).rgb;
				float Alpha = ( ( IN.ase_color.a * temp_output_24_0 ) * distanceDepth35 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord25 = IN.ase_texcoord2.zw * float2( 1,1 ) + float2( 0,0 );
				float2 temp_cast_0 = (texCoord25.y).xx;
				float2 texCoord17 = IN.ase_texcoord2.xy * float2( 1,1 ) + temp_cast_0;
				float temp_output_27_0 = ( ( tex2D( _Main_Tex, uv_Main_Tex ).r * texCoord25.x ) - tex2D( _Dissolve_Tex, texCoord17 ).r );
				float temp_output_24_0 = saturate( temp_output_27_0 );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 texCoord25 = IN.ase_texcoord.zw * float2( 1,1 ) + float2( 0,0 );
				float2 temp_cast_0 = (texCoord25.y).xx;
				...
				surfaceDescription.Alpha = ( ( IN.ase_color.a * temp_output_24_0 ) * distanceDepth35 );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 texCoord25 = IN.ase_texcoord1.zw * float2( 1,1 ) + float2( 0,0 );
				float2 temp_cast_0 = (texCoord25.y).xx;
				float2 texCoord17 = IN.ase_texcoord1.xy * float2( 1,1 ) + temp_cast_0;
				float temp_output_27_0 = ( ( tex2D( _Main_Tex, uv_Main_Tex ).r * texCoord25.x ) - tex2D( _Dissolve_Tex, texCoord17 ).r );
				float temp_output_24_0 = saturate( temp_output_27_0 );
...
/*ASEBEGIN
Version=18935
134.4;344;1337.6;627.8;1266.955;285.2834;1.16132;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;25;-1969.677,231.4831;Inherit;True;1;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;14;-2110.224,11.5394;Inherit;True;Property;_Main_Tex;Main_Tex;1;0;Create;True;0;0;0;False;0;False;-1;None;524f01b577961524b890f867d749bb4e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;17;-2363.17,-170.1957;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,4;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;16;-2111.458,-191.4518;Inherit;True;Property;_Dissolve_Tex;Dissolve_Tex;2;0;Create;True;0;0;0;False;0;False;-1;None;20c0b0cb78525ae45af8eb078147784a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;28;-1743.155,21.42499;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;27;-1583.006,-102.9764;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;10;-648.174,-260.7635;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;37;-545.7754,245.6722;Inherit;False;Constant;_Float0;Float 0;3;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;24;-993.2734,-77.47461;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DepthFade;35;-334.3425,205.7761;Inherit;False;True;True;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;-289.0168,48.7384;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-443.0168,-322.2616;Inherit;False;Property;_inten;inten;0;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;34;-1166.229,-189.4074;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;36;51.14319,79.60336;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;32;-1691.245,173.8362;Inherit;False;Constant;_Float1;Float 1;3;0;Create;True;0;0;0;False;0;False;1.39;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;-302.0168,-199.2616;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.StepOpNode;33;-1374.229,-210.4074;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;348.9113,-62.77875;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;Basic;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;637979749231643820;  Blend;0;0;Two Sided;0;637979749215546910;Cast Shadows;0;637979749199326831;  Use Shadow Threshold;0;0;Receive Shadows;0;637979749267423361;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=9C23810C232F93F90BEEEBE9E1843A8630B84B74