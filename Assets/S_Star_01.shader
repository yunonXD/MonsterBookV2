...
Shader "S_Star_01"
{
	Properties
	{
		...
		[ASEBegin]_Star_Tex_01("Star_Tex_01", 2D) = "white" {}
		_Main_Color_01("Main_Color_01", Color) = (1,1,1,0)
		[ASEEnd]_Color_Inten("Color_Inten", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Main_Color_01;
			float4 _Star_Tex_01_ST;
			float _Color_Inten;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float2 uv_Star_Tex_01 = IN.ase_texcoord3.xy * _Star_Tex_01_ST.xy + _Star_Tex_01_ST.zw;
				float4 tex2DNode10 = tex2D( _Star_Tex_01, uv_Star_Tex_01 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( ( _Main_Color_01 * tex2DNode10.r ) * _Color_Inten ).rgb;
				float Alpha = saturate( ( tex2DNode10.a * IN.ase_color.a ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_Star_Tex_01 = IN.ase_texcoord2.xy * _Star_Tex_01_ST.xy + _Star_Tex_01_ST.zw;
				float4 tex2DNode10 = tex2D( _Star_Tex_01, uv_Star_Tex_01 );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 uv_Star_Tex_01 = IN.ase_texcoord.xy * _Star_Tex_01_ST.xy + _Star_Tex_01_ST.zw;
				float4 tex2DNode10 = tex2D( _Star_Tex_01, uv_Star_Tex_01 );
				
				surfaceDescription.Alpha = saturate( ( tex2DNode10.a * IN.ase_color.a ) );
        ...
        Pass
        {
			...
			{
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 uv_Star_Tex_01 = IN.ase_texcoord1.xy * _Star_Tex_01_ST.xy + _Star_Tex_01_ST.zw;
				float4 tex2DNode10 = tex2D( _Star_Tex_01, uv_Star_Tex_01 );
...
/*ASEBEGIN
Version=18935
0;0;1920;1019;816;304.5;1;True;False
Node;AmplifyShaderEditor.VertexColorNode;17;-174,226.5;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;10;-417,-71.5;Inherit;True;Property;_Star_Tex_01;Star_Tex_01;0;0;Create;True;0;0;0;False;0;False;-1;41f11566873abe64c9ab38435740a821;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;16;82,225.5;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;18;239,145.5;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-4,101.5;Inherit;False;Property;_Color_Inten;Color_Inten;2;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;173,-13.5;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-73,-131.5;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;12;-330,-247.5;Inherit;False;Property;_Main_Color_01;Main_Color_01;1;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;416,41;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;S_Star_01;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;637987515020814871;  Blend;0;0;Two Sided;1;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=235F54B746197B1CF2FCED7B812E6F47F59B7F2C